...
"[project]/.next-internal/server/app/api/dashboard/profile/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/dashboard/profile/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(session.user.id).select("-password -otp -otpExpiresAt -twoFASecret -__v").lean();
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        /* eslint-disable */ console.log(...oo_oo(`1683481998_30_4_39_6_4`, "🔍 DEBUG - Fetched user raw data:", {
            id: user._id,
            city: user.city,
            skills: user.skills,
        ...
        const formattedUser = {
            ...
            email: user.email || '',
            // Contact Information
            contactNumber: user.countryCode && user.phone ? `${user.countryCode}${user.phone}` : '',
            countryCode: user.countryCode || '',
            phone: user.phone || '',
            // Location
            city: user.city || '',
        ...
        /* eslint-disable */ console.log(...oo_oo(`1683481998_114_4_120_6_4`, "✅ DEBUG - Formatted user for frontend:", {
        ...
        /* eslint-disable */ console.error(...oo_tx(`1683481998_127_4_127_50_11`, "❌ Profile fetch error:", error));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__72091495._.js.map