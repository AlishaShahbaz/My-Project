...
"[project]/.next-internal/server/app/api/get-taskers/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/get-taskers/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        /* eslint-disable */ console.log(...oo_oo(`738066131_13_4_13_72_4`, 'lat, lng, search, services', lat, lng, search, services));
        // lat, lng -> numbers
        ...
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $match: filters
            },
            {
                    ...
                    distanceMeters: {
                        $let: {
                            vars: {
                                ...
                                lat2: {
                                    $toDouble: "$location.lat"
                                },
                                lon2: {
                                    $toDouble: "$location.lng"
                                }
                            },
                            in: {
                                $multiply: [
        ...
        /* eslint-disable */ console.error(...oo_tx(`738066131_142_4_142_45_11`, "find-taskers error:", err));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: err.message,
            stack: err.stack
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e68298ee._.js.map