...
"[project]/.next-internal/server/app/api/dashboard/update/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
    ...
    callbacks: {
        ...
        async jwt ({ token, user, account, profile, trigger, session }) {
            ...
            if (account?.provider === "google") {
                let dbUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                    email: profile.email
                });
                if (!dbUser) {
                    dbUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
...
"[project]/src/app/data/rates.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/dashboard/update/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$2f$rates$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/data/rates.js [app-route] (ecmascript)");
;
;
;
;
...
async function PUT(req) {
    try {
        ...
        /* eslint-disable */ console.log(...oo_oo(`281292685_19_4_29_6_4`, "🔍 DEBUG - Received update data:", {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(session.user.id);
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        /* eslint-disable */ console.log(...oo_oo(`281292685_36_4_44_6_4`, "🔍 DEBUG - User before update:", {
        ...
        if (body.newPassword) {
            ...
            const isValid = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["default"].compare(body.currentPassword, user.password);
            ...
            if (body.newPassword.length < 8) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Password must be at least 8 characters."
            }, {
                status: 400
            });
            const isSamePassword = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["default"].compare(body.newPassword, user.password);
            if (isSamePassword) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "New password cannot be same as current."
            }, {
                status: 400
            });
            const hashed = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["default"].hash(body.newPassword, 10);
        ...
        for (const field of editableFields){
            if (body[field] !== undefined) {
                /* eslint-disable */ console.log(...oo_oo(`281292685_105_8_105_57_4`, `🔄 Updating ${field}:`, body[field]));
        ...
        if (body.email && body.email !== user.email) {
            ...
            const existingEmail = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            ...
            /* eslint-disable */ console.log(...oo_oo(`281292685_135_6_135_49_4`, "✅ Updated email:", user.email));
        }
        ...
        if (body.contactNumber) {
            ...
            /* eslint-disable */ console.log(...oo_oo(`281292685_162_6_166_8_4`, "✅ Updated contact:", {
                countryCode: user.countryCode,
                phone: user.phone,
                fullContact: `${user.countryCode}${user.phone}`
            }));
        }
        /* eslint-disable */ console.log(...oo_oo(`281292685_168_4_168_38_4`, "skills", body.skills));
        ...
        if (body.username && body.username !== user.username) {
            const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        ...
        if (user.city && Array.isArray(user.skills) && user.skills.length > 0) {
            const cityData = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$2f$rates$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rates"].find((r)=>r.name === user.city);
            if (cityData) {
                let total = 0;
                const skillNames = [];
                ...
                /* eslint-disable */ console.log(...oo_oo(`281292685_223_8_230_9_4`, "💰 Calculated hourly rate:", total, "for skills:", // skillNames,
                "in city:", user.city));
            } else {
                /* eslint-disable */ console.log(...oo_oo(`281292685_232_8_232_60_4`, "❌ City data not found for:", user.city));
                user.hourlyRate = 0;
            }
        } else {
            /* eslint-disable */ console.log(...oo_oo(`281292685_236_6_236_73_4`, "❌ City or skills missing for hourly rate calculation"));
            user.hourlyRate = 0;
        }
        ...
        if (body.availabilityTiming) {
            user.availabilityTiming = {
                startWork: [
                    ...
                    "tomorrow",
                    "in_one_week"
                ].includes(body.availabilityTiming.startWork) ? body.availabilityTiming.startWork : "today",
                preferredTime: Array.isArray(body.availabilityTiming.preferredTime) ? body.availabilityTiming.preferredTime.filter((time)=>[
                        "morning",
                        "afternoon",
                        "evening"
                    ].includes(time)) : [
                ...
                availableDays: Array.isArray(body.availabilityTiming.availableDays) ? body.availabilityTiming.availableDays.filter((day)=>[
                        "monday",
                        "tuesday",
                        "wednesday",
                        "thursday",
            ...
            /* eslint-disable */ console.log(...oo_oo(`281292685_257_6_257_75_4`, "✅ Updated availabilityTiming:", user.availabilityTiming));
        }
        ...
        if (body.workingHours) {
            ...
            /* eslint-disable */ console.log(...oo_oo(`281292685_271_6_271_63_4`, "✅ Updated workingHours:", user.workingHours));
        }
        // Update timestamps
        user.updatedAt = new Date();
        /* eslint-disable */ console.log(...oo_oo(`281292685_276_4_276_35_4`, "user.skills", user));
        await user.save();
        /* eslint-disable */ console.log(...oo_oo(`281292685_279_4_289_6_4`, "✅ User after save:", {
            id: user._id,
            skills: user.skills,
        ...
        /* eslint-disable */ console.error(...oo_tx(`281292685_325_4_325_46_11`, "❌ Update user error:", err));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d3aa35af._.js.map