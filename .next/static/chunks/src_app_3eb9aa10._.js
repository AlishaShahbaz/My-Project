...
"[project]/src/app/components/auth/OtpVerificationForm.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
function OtpVerificationForm(param) {
    let { email = "" } = param;
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OtpVerificationForm.useEffect": ()=>{
            ...
            const interval = setInterval({
                "OtpVerificationForm.useEffect.interval": ()=>setCooldown({
                        "OtpVerificationForm.useEffect.interval": (sec)=>sec - 1
                    }["OtpVerificationForm.useEffect.interval"])
            }["OtpVerificationForm.useEffect.interval"], 1000);
            return ({
                "OtpVerificationForm.useEffect": ()=>clearInterval(interval)
            })["OtpVerificationForm.useEffect"];
        }
    }["OtpVerificationForm.useEffect"], [
        cooldown
    ...
    const handleResend = async ()=>{
        ...
        try {
            ...
            if (!res.ok) {
                var _result_issues_;
                if (result.issues && ((_result_issues_ = result.issues[0]) === null || _result_issues_ === void 0 ? void 0 : _result_issues_.secondsLeft)) {
                    setCooldown(result.issues[0].secondsLeft); // use backend response
                }
                setServerError(result.error || "Failed to resend OTP");
            } else {
                var _result_data;
                setCooldown(((_result_data = result.data) === null || _result_data === void 0 ? void 0 : _result_data.resendAfter) || 60);
            }
        } catch (err) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                disabled: cooldown > 0,
                className: "rounded-full py-2 px-4 mt-2 border ".concat(cooldown > 0 ? "opacity-50 cursor-not-allowed" : "hover:bg-gray-100"),
                children: cooldown > 0 ? "Resend OTP in ".concat(cooldown, "s") : "Resend OTP"
            }, void 0, false, {
                fileName: "[project]/src/app/components/auth/OtpVerificationForm.js",
                lineNumber: 108,
                columnNumber: 7
...
_s(OtpVerificationForm, "AqMgXTi2HSCJAvhTX52AaUD/oCE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"]
    ];
});
_c = OtpVerificationForm;
...
var _c;
__turbopack_context__.k.register(_c, "OtpVerificationForm");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$auth$2f$OtpVerificationForm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/auth/OtpVerificationForm.js [app-client] (ecmascript)");
...
function SignupForm() {
    _s();
    const { register, handleSubmit, watch, setValue, resetField, formState: { errors } } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"])({
        defaultValues: {
            countryCode: 'US'
        }
    });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SignupForm.useEffect": ()=>{
            ...
            return ({
                "SignupForm.useEffect": ()=>document.removeEventListener('click', onDocClick)
            })["SignupForm.useEffect"];
        }
    }["SignupForm.useEffect"], []);
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            ...
            const result = await res.json();
            if (!res.ok) {
                const serverMsg = (result === null || result === void 0 ? void 0 : result.error) || Array.isArray(result === null || result === void 0 ? void 0 : result.issues) && result.issues.map((i)=>"".concat(i.field, ": ").concat(i.message)).join(' | ') || 'Signup failed';
            ...
            /* eslint-disable */ console.error(...oo_tx("869399824_112_6_112_41_11", 'Signup error:', err));
    ...
    if (step === 'verify') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$auth$2f$OtpVerificationForm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    email: userEmail
                }, void 0, false, {
                    fileName: "[project]/src/app/auth/signup/page.js",
                    lineNumber: 126,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                ...
                children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                src: "https://flagsapi.com/".concat(selectedCountry.code, "/flat/32.png"),
                                                alt: "".concat(selectedCountry.name, " flag"),
                                    ...
                                    open && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        className: "absolute left-0 mt-2 w-60 max-h-56 overflow-auto rounded bg-white border shadow-lg z-50",
                                        children: countries.map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                        src: "https://flagsapi.com/".concat(c.code, "/flat/32.png"),
                                                        alt: "".concat(c.name, " flag"),
                                                        className: "w-6 h-4 object-cover"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/auth/signup/page.js",
                                                        lineNumber: 206,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                    ...register('phone', {
                                        ...
                                        validate: (val)=>{
                                            const c = countries.find((x)=>x.code === (countryCode || 'US')) || countries[0];
                                            const len = (val || '').length;
                                            return len >= c.min && len <= c.max || "Phone number is not valid.";
                                        }
                                    }),
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: submitting ? 'Creating...' : 'Sign Up'
                    }, void 0, false, {
                        fileName: "[project]/src/app/auth/signup/page.js",
                        lineNumber: 347,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: "text-xs px-3 text-gray-600 mt-3 text-center",
                children: [
...
_s(SignupForm, "kBuPxnjPnc7Pf6sl2cZkUXtMof4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"]
    ];
});
...
//# sourceMappingURL=src_app_3eb9aa10._.js.map